...
import com.wearessc.theift_alrm.dont_touch_phone.anti_theift_2022.databinding.ActivityIntruderSelfieBinding
import com.wearessc.theift_alrm.dont_touch_phone.anti_theift_2022.intruderdetection.IntruderAdapter.SelfieAdapter
    ...
    private fun showDeleteConfirmationDialog() {
        ...
        builder.setTitle("Delete")
            ...
            .create().apply {
                ...
                // Set button color
                getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(ContextCompat.getColor(context, R.color.vivid_purple))
                getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(ContextCompat.getColor(context, R.color.vivid_purple))
            }
    }
