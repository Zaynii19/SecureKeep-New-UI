...
import com.wearessc.theift_alrm.dont_touch_phone.anti_theift_2022.databinding.ActivitySettingBinding
...
class SettingActivity : AppCompatActivity() {
    ...
    private fun updateSelectedToneLayout(layout: ConstraintLayout, toneId: Int) {
        selectedLayout?.background = ContextCompat.getDrawable(this, R.color.white)
